...
; Page zero variables
T1     : .res 1 ;;= $35     ; temp variable 1
T2     : .res 1 ;;= $36     ; temp variable 2
ADDR= ADDR1L    ;;= $37     ; instruction address, 2 bytes (low/high)
OPCODE : .res 1 ;;= $39     ; instruction opcode
OP     : .res 8 ;;= $3A     ; instruction type OP_* 8 bytes
AM     : .res 1 ;;= $41     ; addressing mode AM_*
LEN    : .res 1 ;;= $42     ; instruction length
REL    : .res 2 ;;= $43     ; relative addressing branch offset (2 bytes)
DEST   : .res 2 ;;= $45     ; relative address destination address (2 bytes)
...
; External Routines
;;;  ECHO     = WRITE_BYTE ;$FFEF ; Woz monitor ECHO routine
;;;  PRBYTE   = PRINT_HEXA ;$FFDC ; Woz monitor print byte as two hex chars
